...
printc(
    ":smile: 2- Never regret anything that made you smile - Mark Twain", c="r", bold=0
)
printc(
    ":construction: 3- Every moment is a fresh beginning - T.S Eliot",
    c="m",
    underline=1,
)
...
printc(
    ":sparks:10- All limitations are self-imposed - Oliver Wendell Holmes", c=7, dim=1
)
printc(
    ":checked:11- If you tell the truth you don't have to remember anything - Mark Twain",
    underline=True,
    invert=True,
    c="indigo9",
)
