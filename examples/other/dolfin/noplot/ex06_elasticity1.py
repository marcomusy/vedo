"""
Show fenics mesh and displacement solution with arrows.
"""
...
mpts = MeshPoints(u, bmesh).pointSize(10)

arrs = MeshArrows(u, bmesh)  # try also MeshLines(mesh, u)
arrs.color("white").opacity(0.2)

show(mpts, arrs, azimuth=60)
