...
vp = vtkplotter.Plotter(title='first example')
...
vp = vtkplotter.Plotter(title='3 shapes')
...
vp = vtkplotter.Plotter(title='Example of splines through 8 random points')
...
vp = vtkplotter.Plotter(title='Example of PCA analysys')
...
vp = vtkplotter.Plotter(title='color points')
...
vp = vtkplotter.Plotter(title='Example of a 3D function plotting', axes=2)
...
vp = vtkplotter.Plotter(title='Normals and surface edges')
...
vp = vtkplotter.Plotter(shape=(1,2), axes=False)
...
vp = vtkplotter.Plotter(shape=(1,4), title='surface curvature', axes=0)
...
vp = vtkplotter.Plotter(N=9, title='basic shapes')
vp.sharecam   = False
...
vp = vtkplotter.Plotter(shape=(3,3), title='Example 12', interactive=False)
vp.sharecam   = False
...
vp = vtkplotter.Plotter(shape=(3,3), verbose=0, axes=0, interactive=0)
