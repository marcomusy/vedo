...
fp1 = m1.flagpole("Triangle 1\nA=" + a1, point=(2.1, 0.7), s=0.012, offset=(-0.3, 0.04))
fp2 = m2.flagpole("Triangle 2\nA=" + a2, point=(1.9, 0.4), s=0.012, offset=(0.2, -0.2))
...
fp3 = m3.flagpole(
    "Overlap polygon\nA=" + precision(m3.area(), 3), point=(2.2, 0.6), s=0.012
)

show(m1, m2, m3, fp1, fp2, fp3, __doc__, axes=1, size=(800, 600), zoom=1.3).close()
