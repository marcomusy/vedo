...
#
# Setting connectivity to True discards the small isolated pieces of surface
# and only keeps the largest connected surface.
#
...
#
# If the spacing of the tiff stack is uneven in xyz, this can be corrected
# by setting scaling factors with scaling=[xfac,yfac,zfac]
#
import plotter

f = 'data/embryo.tif'

vp = plotter.vtkPlotter(shape=(1,3))
...
vp.show(a0, at=0, interactive=0)
vp.show(a1, at=1)
vp.show(a2, at=2, interactive=1)
