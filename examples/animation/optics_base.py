...
class Ray:
    ...
    def trace(self, elements):
        ...
        for element in elements:
            self.tolerance = element.diagonal_size() / 1000.0
            ...
            for _ in range(self.maxiterations):
                ...
                hit, cid = (
                    hits[0],
                    cids[0],
                )  # grab the first hit, point and cell ID of the mesh
    ...
    def asLine(self, min_hits=1, max_hits=1000, c=None, cmap_amplitudes="", vmin=0):
        ...
        if min_hits < len(self.path) < max_hits:
            ...
            if cmap_amplitudes:
                ...
                c = (
                    vedo.colors.color_map(self.wave_length, "jet", 450e-09, 750e-09)
                    / 1.5
                )
                ln.color(c)
            else:
