...
line1 = Spline(pts).lw(5).c('black').rotateY(15).rotateX(25)
line2 = Line(p1,p2).lw(5).c('green').rotateY(15).rotateX(25)

# make a small extrusion of line1 and intersect it with line2:
ds = line1.diagonalSize()*0.01  # 1% tolerance
...
msh = Line(line1.points()[id0:id1]).triangulate().lw(0).shift(0,0,-0.02)

show(line1, line2, ps, msh, __doc__+f"\narea = {msh.area()} cm\^2", axes=1)
