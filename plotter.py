...
class vtkPlotter:
    ...
    def help(self):
        ...
        ### Declare an instance of a class vtkPlotter:
        import plotter
        vp = plotter.vtkPlotter()
        vp.help() # shows this help page
        
        ### Load a vtk file as a vtkActor and visualize it as wireframe
        ### with a ruler on top, quit python when closing the window 
        actor = vp.loadActor('data/xavis/vtk/290.vtk')
        actor.GetProperty().SetRepresentationToWireframe()
        vp.show(actor, ruler=1, q=1)
        # same as vp.show(actors=[actor], ruler=1, q=1)
        ...
        vp.loadActor('data/xavis/vtk/250.vtk', c=(1,0.4,0))
        vp.loadActor('data/xavis/vtk/270.vtk', c=(1,0.6,0))
        vp.loadActor('data/xavis/vtk/290.vtk', c=(1,0.8,0))
    ...
    def show(self, actors=None, polys=None, legend=None, at=0, #at=render wind. nr.
             axes=None, ruler=False, interactive=None, outputimage=None, q=False):
    ...
    ###################
    def interact(self, outputimage=False, q=False):
