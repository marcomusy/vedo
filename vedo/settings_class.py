...
class Settings:
    ...
    def __init__(self, level=0):
        ...
        self.maximum_number_of_peels = 4
    ...
    def warn(self, key):
        if self.level == 0:
            print(f'Warning. Please use "settings.{key}" instead!')
    ...
    def maxNumberOfPeels(self):
        self.warn("maximum_number_of_peels")
        return self.maximum_number_of_peels
    @maxNumberOfPeels.setter
    def maxNumberOfPeels(self, value):
        self.maximum_number_of_peels = value
    ##################################
    @property
