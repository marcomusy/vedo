...
class ButtonWidget:
    ...
    def __init__(
        ...
        [buttons3.py](https://github.com/marcomusy/vedo/tree/master/examples/basic/buttons3.py)
        """
...
class DrawingWidget:
    ...
    def __init__(self, obj, c="green5", lw=4, closed=False, snap_to_image=False):
        ...
        self.widget.SetProjectionNormal(2)  # XY plane
    ...
    def callback(self, widget, _event_name) -> None:
        ...
        # print(f"There are {path.GetNumberOfPoints()} points in the line.")
