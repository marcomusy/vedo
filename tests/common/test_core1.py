...
assert len(arr)
print("pointdata", np.max(arr), ">", 0.99)
assert np.max(arr) > 0.99

arr = sphere.celldata["carr"]
print("celldata", [arr])
assert len(arr)
print("celldata", np.max(arr), ">", 0.99)
assert np.max(arr) > 0.99
...
assert np.allclose(
    sphere.closest_point(pt), [0.19883616, 0.48003298, 0.85441941], atol=0.001
)
